    ...
    <div className="h-screen">
      <div className="h-[761.51px] bg-cover rounded-3xl m-5 my-10 shadow-md bg-[url('https://img.freepik.com/free-photo/medic-african-ethnicity-helping-sick-patient-clinic-hospital-ward-doctor-using-medical-equipment-technology-young-woman-healthcare-treatment-black-person-bed_482257-16526.jpg?t=st=1716722515~exp=1716726115~hmac=6788e0c25a0477a93bfcbc1ac9222b2e97c999e4c0860431797eb2c4fd734b25&w=740')]">
        ...
        <div className="text-white flex justify-center items-center h-[20%]">
          <button className="font-semibold text-4xl bg-[#B273F0] p-7 rounded-full hover:bg-white hover:text-black active:bg-black active:text-white">
            Get Started
          </button>
        </div>
      </div>
      ...
      <div className="h-[600px] bg-[#4D4949]">
            ...
            <div className="">
              <div className="flex justify-evenly items-center m-5">
                <div className="relative h-[110px] w-[110px]">
                  <a href="https://www.linkedin.com/in/nicole-lynsey-6b313b235/" target="_blank">
                    <img
                      src={nicole}
                ...
                <div className="relative h-[110px] w-[110px]">
                  <a href="https://www.linkedin.com/in/ephraim-shikanga/" target="_blank">
                    <img
                      src={ephraim}
                ...
                <div className="relative h-[110px] w-[110px]">
                  <a href="https://www.linkedin.com/in/coll-treks-45106922a/" target="_blank">
                    <img
                      src={collins}
        ...
        <div className="border-t-2 mx-5 flex p-2 text-white">
          <div className="w-3/4 flex justify-evenly m-5">
