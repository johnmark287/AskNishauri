...
function LandingNavbar({ setOpen }) {
  return (
    <div className="bg-[#FBE4FF] flex justify-between items-center p-1 shadow-md ">
      ...
      <button className="transition hover:transition hover:scale-105 active:transition bg-[#B273F0] rounded-3xl px-6 py-2 text-white text-2xl hover:bg-white hover:text-black active:bg-black active:text-white">
        Login
      </button>
    </div>
  );
