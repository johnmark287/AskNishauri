  ...
  return (
    <div className="relative flex justify-between bg-[hsl(216,8%,12%)] border-b border-gray-700 p-3 te">
      ...
      <div className="flex justify-between">
        <button
          type="button"
          className="px-2 mx-1 text-[rgba(37,188,134,255)] rounded-2xl bg-[rgba(30,48,44,255)]"
        >
          Export chat
        </button>
        <button type="button" className="mx-1"> {/* Dropdown menu: Export chat, change language, theme, delete whole chat */}
          <svg
            className="fill-current text-[rgba(82,91,100,255)] "
            xmlns="http://www.w3.org/2000/svg"
            height="24px"
            viewBox="0 -960 960 960"
            width="24px"
        ...
        <button type="button" className="mx-1"> {/* hidden on large screen size and visible on small screen size */}
          <svg
            className="fill-current text-[rgba(82,91,100,255)]"
            xmlns="http://www.w3.org/2000/svg"
            height="24px"
