  ...
  return (
    <aside className={`${open ? "w-[260px]" : "w-[-260px]"} duration-300 bg-[rgba(35,38,43,255)] h-screen flex flex-col text-[rgba(131,142,152,255)]`}>
      <div className="flex justify-between text-left m-1 p-[6px] relative border-b border-b-gray-500">
        <div className={`${open ? "" : "hidden"} py-[2.23px]`}>
          AskNishauri
        </div>
      ...
      <button type="button" className={`${open ? "" : "hidden"} hover:bg-[rgba(131,142,152,255)] active:bg-[rgba(29,31,34,255)] my-2 py-[7px] bg-[rgba(72,81,89,255)] rounded-3xl w-[90%] self-center text-white`}>
        Create chat
      </button>
      <div className={`${open ? "" : "hidden"} m-2`}>
        History
      </div>
    </aside>
  )
